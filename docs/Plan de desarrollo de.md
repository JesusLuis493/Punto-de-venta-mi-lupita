...
### Dia 2: Propuesta inicial
- [ ] Diseño inicial de la base 
...
### Dia 3: Creacion de puebas unitarias
- [ ] Crear scripts para pruebas unitarias para cada tabla.
- [ ] Crear suite de testing con logs para el usuario.
- [ ] Unificar scripts en suite de testing.

### Dia 4: Estructuracion en mysql.
- [ ] Creacion de la base de datos "Negocio: mi lupita".
- [ ] Creacion de tablas requeridas segun el esquema.
- [ ] Revision de referencias primarias y foraneas.
- [ ] Ejectutar suite de testing.
- [ ] Refactorizar (en caso de ser nesesario).

### Dia 5: Finalizacion de la base de datos
- [ ] Ejecusion de prueba en entorno aislado (contenedor).
